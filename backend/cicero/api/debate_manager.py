...
# Builds the engine (wired with the manager's listener) and its budget.
BuildEngine = Callable[[TurnListener], tuple[DebateEngine, DebateBudget]]
...
class DebateManager:
    ...
    def start(self, chamber: Chamber, build_engine: BuildEngine) -> None:
        ...
        engine, budget = build_engine(listener)
